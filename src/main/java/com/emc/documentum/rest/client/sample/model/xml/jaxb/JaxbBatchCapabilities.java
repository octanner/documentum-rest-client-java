...
@XmlRootElement(name="batch-capabilities", namespace=XMLNamespace.DM_NAMESPACE)
public class JaxbBatchCapabilities extends JaxbDmLinkableBase implements Capabilities {
    ...
    @XmlElement(name="batchable-resource", namespace=XMLNamespace.DM_NAMESPACE)
    ...
    @XmlElement(name="non-batchable-resource", namespace=XMLNamespace.DM_NAMESPACE)
